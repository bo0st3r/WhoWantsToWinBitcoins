...
public class ProjStackPane extends BorderPane {
	...
	private AddQuestionGridPane aqGridPane;
	...
	public StackPane getStackPane() {
		if (stackPane==null) {
			...
			stackPane.getChildren().addAll(	getHomeGridPane(),
											getPlayingGridPane(),
											getAqGridPane(),
											getAboutGridPane());
		}
	...
	public AddQuestionGridPane getAqGridPane() {
		if (aqGridPane==null) {
			aqGridPane = AddQuestionGridPane.getSingleton();
		}
		return aqGridPane;
	}
