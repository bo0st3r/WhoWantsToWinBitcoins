...
public class PlayingGridPane extends GridPane {
	...
	public PlayingGridPane() {
		...
		getBtnA().setId("answers");
		getBtnB().setId("answers");
		getBtnC().setId("answers");
		getBtnD().setId("answers");
